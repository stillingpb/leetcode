...
public class Populating_Next_Right_Pointers_in_Each_Node_II {
    ...
    public void connect2(TreeLinkNode root) {
        ...
        TreeLinkNode node = root.right == null ? root.left : root.right;
        TreeLinkNode nextPar = root.next;
        while (nextPar != null) {
            if (nextPar.left != null || nextPar.right != null) {
                TreeLinkNode next = nextPar.left != null ? nextPar.left : nextPar.right;
                node.next = next;
                break;
            }
        }
